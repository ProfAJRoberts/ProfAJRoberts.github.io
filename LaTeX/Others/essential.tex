...
% Here modified slightly by AJRoberts for LaTeX2e.
...
\author{Jon Warbrick\\ U05.04--202}
...
The main reference for \LaTeX{} is \emph{The \LaTeX{} User's guide and
...
differ in one way or another.  Instead, they both refer to a \emph{local
...
Fundamental to \LaTeX{} is the idea of a \emph{document style\/} that
...
These standard styles can be modified by a number of \emph{style options\/}.
...
useful in all European countries. The \fn{a4paper} option causes the output in all
