...
4A/(\pi d^2) \) if it were not for the wastage around the perimeter of 
each disc.
...
N$ and $d$ involves a fractional exponent $D$: $N\propto 
d^{-D}$.  It is only reasonable for us to say that the 
