...
\usepackage[paperwidth=128mm,paperheight=72mm,margin=7ex]{geometry}
\or% case 1
\documentclass[12pt,smallborder]{refart}
\usepackage[paperwidth=128mm,paperheight=96mm,margin=5ex]{geometry}
\settextfraction{0.75}
\or% case 2
\documentclass[12pt,twocolumn]{article}
\usepackage[paperwidth=170mm,paperheight=96mm,margin=7ex]{geometry}
\fi
